...
class MainUiWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_satellite_button.setVisible(False)
        self.remove_satellite_button.setVisible(False)
        self.add_transponder_button.setVisible(False)
        self.remove_transponder_button.setVisible(False)
